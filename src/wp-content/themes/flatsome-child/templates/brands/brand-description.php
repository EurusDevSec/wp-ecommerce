...
<div class="term-description brand-description">
		...
		<img src="<?php echo esc_url( $thumbnail ); ?>" alt="<?php echo esc_attr( single_term_title( '', false ) ); ?>" class="wp-post-image alignright fr brand-thumbnail" width="<?php echo esc_attr( $image_size['width'] ); ?>" />
	<?php endif; ?>
